...
const OurServices:FC = () => {
    ...
    return (
        <section id='ourServices' className='text-white py-20 max-w-screen-lg m-auto bg-[#01000D]'>
            <header className='sm:flex justify-between mx-7 lg:mx-0 items-center'>
            ...
            <div className='text-center my-5 flex flex-wrap md:flex-nowrap'>
